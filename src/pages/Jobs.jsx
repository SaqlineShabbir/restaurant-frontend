...
import ApplyModal from '../components/models/ApplyModal';
const Jobs = () => {
  const [control, setControl] = useState(false);
  return (
    <div>
      <div className="lg:flex space-x-10  w-[100%] lg:px-[200px] px-10 py-20  dark:bg-[#0a0f1c] dark:text-white min-h-[100vh]">
